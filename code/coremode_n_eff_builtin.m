function n_eff_1 = coremode_n_eff_builtin(lambda_0,r_1)
%COREMODE_N_EFF_BUILTIN Calculates the core effective refractive index for a given
%wavelength using builtin bisection methods
